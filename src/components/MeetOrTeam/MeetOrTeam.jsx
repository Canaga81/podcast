    ...
    return (
        <section className='meetOrTeam'>
            <div className="meetOrTeam_container">
                <h2 className='meetOrTeam_title'>Meet Our Team</h2>
                <div className="meetOrTeam_cards_container">
                    {
                            ...
                            return (
                                <div className="meetOrTeam_card" key={idx}>
                                    ...
                                    <div className="meetOrTeam_card_name_job_icons">
                                        ...
                                        <div className="meetOrTeam_icons">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g clipPath="url(#clip0_312_2692)">
