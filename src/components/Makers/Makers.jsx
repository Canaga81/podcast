            ...
            <div className="makers_container">
                <div className="makers_container-left">
                    <div className="makers_left_text_cont">
                        <h2 className='makers_title'>A podcast for makers and entrepreneurs</h2>
                        <p className='makers_desc'>
                            ...
                            id est laborum et dolorum fuga. <br /> <br />
                    ...
                    <div className="makers_left_text_cont">
                        <h3 className='makers_title'>Apparently we had reached a great height
                            in the atmosphere, for the sky was a dead black
                        </h3>
                        <p className='makers_desc'>
                            At vero eos et accusamus et iusto odio dignissimos
                        ...
                        <ul className='makers_ul'>
                            ...
                            <li className='makers_li'>the culture around us as we orient
