    ...
    return (
        ...
        <div className='cardItem'>
            <div className="cartItem_image">
                ...
                <Link to={`/allblogitem/${props.id}`}><img onClick={window.scrollTo(0, 0)} className='cartItem_Image' src={props.image} alt="CartImage" /></Link>
            </div>

            <div className="cartItem_title_text_icon">
                <h3 className='cartItem_title'>{props.title}</h3>
                <p className='cartItem_text'>{props.desc}</p>
                <div className="cartItem_icon_listen">
                    <p className='listen_text'>Read Now</p>
                </div>
            </div>
        </div>
